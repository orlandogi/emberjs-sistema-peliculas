...
export default class TicketTicketComponent extends Component {
  ...
  @action async movieDeleteTicket(id) {
    try {
      ...
      axios.delete(
        `https://backend-express-production-be7d.up.railway.app/api/ticket/${id}`,
      ));
  ...
  calcularTotal2() {
    ...
    document.getElementById('totalPrecioTicketsEdit').textContent =
      '$' + total.toFixed(2) + ' mx';
  }

  actualizarElementosUI2() {
    // Actualizar el total de asientos
    document.getElementById('totalAsientosEdit').textContent =
      this.numAdultos2 + this.numNiños2;

    // Actualizar los códigos de asientos
    document.getElementById('codigoAsientosEdit').textContent =
      this.asientos2.join(', ');
  }
  ...
  @action editarTicket(edit) {
    ...
    document.getElementById('precioAdulto22').textContent =
      '$' + this.precioAdulto2 + ' mx';
    document.getElementById('precioNiñoEdit').textContent =
      '$' + this.precioNiño2 + '.00 mx';
  ...
  @action async comprar2() {
    try {
      await ((document.getElementById('cerrarModalTicket').disabled = true),
      (document.getElementById('ComprarBoletoTickEdit').disabled = true),
      (document.getElementById('cerrarTicketEdit').disabled = true),
      (document.getElementById('imprimirTicket').disabled = true),
      axios({
        method: 'put',
        ...
        data: {
          ...
          adultos: parseInt(
            document.getElementById('numAdultos22').textContent,
          ),
