...
export default class UploadMovieUploadMovieComponent extends Component {
  ...
  handleSalaSelection1(event) {
    ...
    if (selectedValue == '0') {
      ...
      selectedValue == this.selectedSala2 ||
      selectedValue == this.selectedSala3
    ) {
  ...
  handleSalaSelection2(event) {
    ...
    if (selectedValue == '0') {
      ...
      selectedValue == this.selectedSala1 ||
      selectedValue == this.selectedSala3
    ) {
  ...
  handleSalaSelection3(event) {
    ...
    switch (selectedValue) {
      ...
      case '2':
        ...
        document.getElementById('horarios3').textContent = this.horarioSala2;
        break;
      case '3':
        document.getElementById('btnAgregarHorarios3').disabled = false;
        etiquetas1.forEach((etiqueta) => {
        ...
        document.getElementById('horarios3').textContent = this.horarioSala3;
        break;
      case '4':
        document.getElementById('btnAgregarHorarios3').disabled = false;
        etiquetas1.forEach((etiqueta) => {
        ...
        document.getElementById('horarios3').textContent = this.horarioSala4;
        break;
      case '5':
        document.getElementById('btnAgregarHorarios3').disabled = false;
        etiquetas1.forEach((etiqueta) => {
        ...
        document.getElementById('horarios3').textContent = this.horarioSala5;
        break;
      case '6':
        document.getElementById('btnAgregarHorarios3').disabled = false;
        etiquetas1.forEach((etiqueta) => {
        ...
        document.getElementById('horarios3').textContent = this.horarioSala6;
        break;
      case '7':
        document.getElementById('btnAgregarHorarios3').disabled = false;
        etiquetas1.forEach((etiqueta) => {
        ...
        document.getElementById('horarios3').textContent = this.horarioSala3D;
        break;
      default:
        alert('no selecciono ninguna opción');
        break;
  ...
  eliminarEtiqueta1(tag) {
    ...
    if (
      (minutosRestantes == 5 || minutosRestantes == 10) &&
      minutosExtra == 0
    ) {
      minutosRestantes += 15;
      minutosExtra += 15;
    ...
    if (horas < 0) {
      ...
      document.getElementById('horarios1').textContent =
        nuevaHora + ' ' + periodo;
    }
    tag.remove();
  ...
  eliminarEtiqueta2(tag) {
    ...
    if (horas < 0) {
      ...
      document.getElementById('horarios2').textContent =
        nuevaHora + ' ' + periodo;
    }
    tag.remove();
  ...
  eliminarEtiqueta3(tag) {
    ...
    if (horas < 0) {
      ...
      document.getElementById('horarios3').textContent =
        nuevaHora + ' ' + periodo;
    }
    tag.remove();
          ...
          if (priceMovie.value.length >= 4 && !priceMovie.value.includes('.')) {
            ...
            if (
              ...
              try {
                ...
                formData.append(
                  'sala1',
                  document.getElementById('selectHorarios1').value,
                );
                formData.append(
                  'sala2',
                  document.getElementById('selectHorarios2').value,
                );
                formData.append(
                  'sala3',
                  document.getElementById('selectHorarios3').value,
                );

                const horarios1 = document.querySelectorAll('.etiqueta1');
                const textoHorarios1 = Array.from(horarios1).map(
                  (tag) => tag.textContent,
                );
                let horarios11 = [];
                ...
                if (document.querySelectorAll('.etiqueta2').length == 0) {
                  ...
                  const textoHorarios2 = Array.from(horarios2).map(
                    (tag) => tag.textContent,
                  );
                ...
                if (document.querySelectorAll('.etiqueta3').length == 0) {
                  ...
                  const textoHorarios3 = Array.from(horarios3).map(
                    (tag) => tag.textContent,
                  );
                ...
                await ((document.getElementById('cerrarUpload').disabled =
                  true),
                (document.getElementById('publicarMovie').disabled = true),
                (document.getElementById('cerrarUploadMovie').disabled = true),
                axios({
                  method: 'post',
                ...
                if (document.getElementById('selectHorarios1').value == '1') {
                  ...
                  document.getElementById('selectHorarios1').value == '2'
                ) {
                  this.horarioSala2 =
                    document.getElementById('horarios1').textContent;
                } else if (
                  document.getElementById('selectHorarios1').value == '3'
                ) {
                  this.horarioSala3 =
                    document.getElementById('horarios1').textContent;
                } else if (
                  document.getElementById('selectHorarios1').value == '4'
                ) {
                  this.horarioSala4 =
                    document.getElementById('horarios1').textContent;
                } else if (
                  document.getElementById('selectHorarios1').value == '5'
                ) {
                  this.horarioSala5 =
                    document.getElementById('horarios1').textContent;
                } else if (
                  document.getElementById('selectHorarios1').value == '6'
                ) {
                  this.horarioSala6 =
                    document.getElementById('horarios1').textContent;
                } else if (
                  document.getElementById('selectHorarios1').value == '7'
                ) {
                  this.horarioSala3D =
                    document.getElementById('horarios1').textContent;
                }
                if (document.getElementById('selectHorarios2').value == '1') {
                  ...
                  document.getElementById('selectHorarios2').value == '2'
                ) {
                  this.horarioSala2 =
                    document.getElementById('horarios2').textContent;
                } else if (
                  document.getElementById('selectHorarios2').value == '3'
                ) {
                  this.horarioSala3 =
                    document.getElementById('horarios2').textContent;
                } else if (
                  document.getElementById('selectHorarios2').value == '4'
                ) {
                  this.horarioSala4 =
                    document.getElementById('horarios2').textContent;
                } else if (
                  document.getElementById('selectHorarios2').value == '5'
                ) {
                  this.horarioSala5 =
                    document.getElementById('horarios2').textContent;
                } else if (
                  document.getElementById('selectHorarios2').value == '6'
                ) {
                  this.horarioSala6 =
                    document.getElementById('horarios2').textContent;
                } else if (
                  document.getElementById('selectHorarios2').value == '7'
                ) {
                  this.horarioSala3D =
                    document.getElementById('horarios2').textContent;
                }
                if (document.getElementById('selectHorarios3').value == '1') {
                  ...
                  document.getElementById('selectHorarios3').value == '2'
                ) {
                  this.horarioSala2 =
                    document.getElementById('horarios3').textContent;
                } else if (
                  document.getElementById('selectHorarios3').value == '3'
                ) {
                  this.horarioSala3 =
                    document.getElementById('horarios3').textContent;
                } else if (
                  document.getElementById('selectHorarios3').value == '4'
                ) {
                  this.horarioSala4 =
                    document.getElementById('horarios3').textContent;
                } else if (
                  document.getElementById('selectHorarios3').value == '5'
                ) {
                  this.horarioSala5 =
                    document.getElementById('horarios3').textContent;
                } else if (
                  document.getElementById('selectHorarios3').value == '6'
                ) {
                  this.horarioSala6 =
                    document.getElementById('horarios3').textContent;
                } else if (
                  document.getElementById('selectHorarios3').value == '7'
                ) {
                  this.horarioSala3D =
                    document.getElementById('horarios3').textContent;
                }
                ...
                if (error.message === 'En estreno') {
                  Swal.fire({
                    ...
                    icon: 'error',
                    title:
                      'La fecha de inicio de esta pelicula ya esta en estreno',
                    showConfirmButton: false,
                    timer: 2000,
                  });
                }
  ...
  @action async movieDeleteUpload(id) {
    try {
      alert(id);
      await ((document.getElementById('publicarMovie').disabled = true),
      (document.querySelectorAll('btnEliminarMovieUpload').disabled = true),
      axios.delete(
        `https://backend-express-production-be7d.up.railway.app/api/uploadMoviePublish/${id}`,
      ));
      await this.UpdateListAllMoviesUpload();
      document.getElementById('publicarMovie').disabled = false;
