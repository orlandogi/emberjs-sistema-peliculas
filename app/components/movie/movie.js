...
async insertMovie(event) {
  try {
    ...
    formData.append('strNombre', document.getElementById('recipient-movie').value);
    formData.append('strSinopsis', document.getElementById('synopsisMovie').value);
    formData.append('intDuracion', document.getElementById('numberDuration').value);
    if (document.getElementById('opDisponible').selected) {
      formData.append('idEstadoPelicula', document.getElementById('opDisponible').value);
    } else {
      formData.append('idEstadoPelicula', document.getElementById('opRetirada').value);
    }
    ...
    const response = await axios.post('http://localhost:3000/api/pelicula', formData, {
      headers: {
